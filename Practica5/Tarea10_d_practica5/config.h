...
#define IO_KEY       "aio_xqbz87HBb47ycfGwOolqfHq8pah1" // Put your Adafruit IO AIOKEY
/*********** WIFI **************/
...
const char* ssid = "Marta"; // Put your own WiFi ssid
const char* password = "Marta2001"; // Put your own WiFi password
